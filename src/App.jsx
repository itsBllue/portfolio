...
import FiveMUpworklogo from './FiveMUpworklogo.png';
  ...
  return (
    <div className="App">
      <div className="Profile">
        <div id='Profile_Picture'> <img src={logo} ></img></div>
        ...
        <div className="AboutMeQuote">
          <p>8i2hjnr92nr928bnr92nr92r2?r9j29rj29rhn2r#?</p>
          <h1>A jack of all trades is a master of some but always better than a master of one.</h1></div>
      ...
      <div className='Education'>
        ...
        <div className='EduSection'>
          {/* <img src={logo}></img> */}
          <SchoolTwoTone color='primary' className='icon'></SchoolTwoTone>
        ...
        <div className='EduSection'>
          {/* <img src={logo}></img> */}
          <SchoolTwoTone color='secoundary' className='icon'></SchoolTwoTone>
          <div className='Content'>
          <h1>A Levels</h1>
        ...
        <div className='EduSection'>
          {/* <img src={logo}></img> */}
          <SchoolTwoTone color='success' className='icon'></SchoolTwoTone>
          <div className='Content'>
          <h1>GCSEs</h1>
          <p>London Academy</p>
          <p>2021-2021</p>
      ...
      <div className="Experiance">
        ...
        <div className='vl'></div>
            ...
            <div className='ExpSection'> 
            <div id='dot'  style={{background:'#550091'}}><hr></hr></div>
            <div className='Picture' id='UWTech'> <svg id='UWTechIcon' width="45" height="20" viewBox="0 0 204 38" preserveAspectRatio="xMinYMid slice" xmlns="http://www.w3.org/2000/svg">
