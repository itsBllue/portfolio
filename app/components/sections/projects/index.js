...
export default function projectsection(props){
    ...
    return(<section id="projects" className='bg-slate-900 text-neutral-content'>
        ...
        <h1 className='section-title' style={{top:'-3.5rem'}}>Projects</h1>
            <p className="font-medium text-black">Click on the project for more information.</p></div>
        </div>
